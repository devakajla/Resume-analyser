      ...
      <div className="w-full max-w-md glass-panel rounded-2xl shadow-2xl shadow-black/80 p-8 space-y-6 relative z-10">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-zinc-400">
            Join Resume Analyser to manage and track screening pipelines
          </p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-zinc-900/60 border border-zinc-800/80 rounded-lg px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200 appearance-none cursor-pointer"
              >
                <option value="candidate" className="bg-zinc-900 text-zinc-100">
